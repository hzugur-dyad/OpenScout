...
export const interviewUi = {
  en: {
    ...
    interviewTipsBullets: [
      ...
      "Your microphone opens automatically after Nova finishes speaking.",
      "If you do not start speaking within 7 seconds, Nova repeats the question once; another silent turn moves to the next topic.",
      "After you start speaking, a 4-second pause ends your answer automatically.",
      "Do not interrupt Nova while the microphone is locked.",
    ...
    statusConnectingVoice: "Connecting voice...",
    statusRetryingVoice: "Voice connection timed out upstream. Retrying...",
    statusWaitNova: "Wait for Nova to finish...",
    statusListening: "Listening for your answer...",
    statusClickToRespond: "Microphone will open automatically",
    micAriaStartListening: "Open microphone for your answer",
    ...
    voiceServiceUnavailable: "Voice service temporarily unavailable. Please try again.",
    voicePlaybackIssue: "Voice audio is unavailable right now. Transcript will keep updating.",
