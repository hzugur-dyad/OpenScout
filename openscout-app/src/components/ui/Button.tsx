...
const variants = {
  primary:
    "bg-primary text-white shadow-[0_1px_0_rgba(255,255,255,0.12)_inset,0_1px_2px_rgba(0,0,0,0.08)] hover:bg-primary-dark active:bg-primary-dark dark:shadow-[0_1px_0_rgba(255,255,255,0.08)_inset,0_2px_8px_rgba(0,0,0,0.25)]",
  secondary:
