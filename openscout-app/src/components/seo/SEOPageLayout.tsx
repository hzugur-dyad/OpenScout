    ...
    <div className="py-12">
      ...
      <Container>
        <article className="mx-auto max-w-3xl">
          ...
          <section className="mt-12 rounded-[10px] border border-[var(--border)] bg-white p-8 shadow-soft dark:border-white/[0.12] dark:bg-black/25 dark:backdrop-blur-xl">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              ...
              <Link
                href="/cv-analysis"
                className="inline-flex items-center justify-center rounded-[10px] border border-[var(--border)] px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-white/[0.18] dark:text-zinc-200 dark:hover:bg-black/40"
              >
                Analyze your CV
              </Link>
              <Link
