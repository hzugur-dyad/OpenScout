        ...
        <div className="mt-8 space-y-6">
          ...
          <div
            ...
            className={`flex flex-col items-center justify-center rounded-[10px] border-2 border-dashed p-12 transition-colors ${
              isDragging ? "border-primary bg-primary-muted/30" : "border-gray-300 bg-gray-50"
            }`}
          >
            ...
            <p className="mt-1 text-xs text-gray-400">PDF or TXT only - max 10MB</p>
            <input
              ref={fileInputRef}
              type="file"
        ...
        >
          {result.cv_holder && (result.cv_holder.full_name || result.cv_holder.current_role || result.cv_holder.summary_line) && (
            <div className="rounded-[10px] border border-[var(--border)] bg-white p-6 shadow-card">
              <h3 className="mb-4 text-lg font-semibold">CV summary</h3>
              <dl className="grid gap-2 text-sm sm:grid-cols-2">
                ...
                {result.cv_holder.department_or_field && (
                  <>
                    <dt className="font-medium text-gray-500">Department / field</dt>
          ...
          {result.detailed_report && (
            <div className="rounded-[10px] border border-[var(--border)] bg-white p-6 shadow-card">
              <h3 className="mb-3 text-lg font-semibold">Expert assessment</h3>
          ...
          <div className="rounded-[10px] border border-[var(--border)] bg-white p-6 shadow-card">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold">Overall Score: {result.overall_score}/100</h2>
          ...
          <div className="rounded-[10px] border border-[var(--border)] bg-white p-6 shadow-card">
            <h3 className="font-semibold">Category scores and feedback</h3>
