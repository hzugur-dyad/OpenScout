...
export default async function EmployerApplicationDetailPage({
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <Link href={`/employer/${jobId}/applications`} className="text-sm text-gray-500 hover:underline dark:text-zinc-400 dark:hover:text-zinc-300">
      ...
      <div className="mt-8 space-y-6">
        <div className="rounded-[10px] border border-[var(--border)] bg-white p-6 shadow-soft dark:border-zinc-700 dark:bg-zinc-900">
          ...
          {profile?.email && (
            <p className="text-sm text-gray-500 dark:text-zinc-400">{profile.email}</p>
          )}
        ...
        <div className="rounded-[10px] border border-[var(--border)] bg-white p-6 shadow-soft dark:border-zinc-700 dark:bg-zinc-900">
          ...
          <div className="mt-3 flex flex-wrap gap-6">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900 dark:text-zinc-100">{application.status}</p>
            </div>
          </div>
