...
async def run_test():
    ...
    try:
        ...
        # -> Input the provided email into the email field ([389]), input the provided password into the password field ([390]), then click the 'Log In' button ([391]).
        ...
        # -> Click the 'Complete Your Profile' CTA (element index 1072) to enter the onboarding flow and trigger navigation to the onboarding page.
        frame = context.pages[-1]
        # Click element
