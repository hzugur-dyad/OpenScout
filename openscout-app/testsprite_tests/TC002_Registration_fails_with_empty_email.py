...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /register (explicit test step)
        await page.goto("http://localhost:3000/register", wait_until="commit", timeout=10000)
        
        # -> Fill Password and Confirm Password with the provided password (leave Email blank) and click 'Sign Up' to trigger validation.
        ...
        if 'Register' not in txt:
            raise AssertionError("Expected text 'Register' to be visible on the page but it was not found.")
